...
Clone this [repository](https://github.com/iamchristianani/railsblog.git) to your desired folder:
...
Feel free to check the [issues page](https://github.com/iamchristianani/railsblog/issues).
